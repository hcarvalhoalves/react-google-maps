...
var StaticMapWidget = React.createClass({
  getDefaultProps: function() {
    return {
      latitude: 0,
      longitude: 0,
  ...
  render: function() {
    ...
    return this.transferPropsTo(<img src={"http://maps.googleapis.com/maps/api/staticmap?" + params}/>);
  }
});
...
var AutocompleteField = React.createClass({
  ...
  render: function(){
    return this.transferPropsTo(<input type="text" onChange={this.handleInputChange}/>);
  }
});
